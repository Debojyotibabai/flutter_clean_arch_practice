  ...
  Widget build(BuildContext context) {
    return BlocBuilder<GetGroupDetailsBloc, GetGroupDetailsState>(
      builder: (context, state) {
        if (state is GetGroupDetailsLoading) {
          return SpinKitThreeInOut(
            color: Colors.yellow[700],
          );
        } else if (state is GetGroupDetailsSuccess) {
          return Row(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    selectedMenuItem != "Edit Group Location"
                        ? Text(
                            "Created by ${state.groupDetails.creator!.firstName} ${state.groupDetails.creator!.lastName} | ${state.groupDetails.city}, ${state.groupDetails.state}",
                            style: const TextStyle(
                              fontSize: 18,
